...
The design of version 2 is aimed at the OpenScan Shield version 2 but can also be used for version 1 (when printing a fitting enclosure for the version 1 OpenScan Shield). The BOM will be different from v1:
...
| lubricant | 1-2 ml | lubricant that doesn't dissolve printed parts, ie, white lithium grease, for cog wheel and rotor |
...
| M1.6x12 (self-tapping optional) | 2 | endstop: through the endstop and directly into the plastic of the base, self-tapping screws also work great |
